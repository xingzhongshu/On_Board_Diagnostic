...
public:
	DynamixelClass(HardwareSerial& _serial, uint8_t pind) : serial(_serial), Direction_Pin(pind) {}

	void begin(long baud, int8_t directionPin = -1);
	void end(void);


	void writeraw(uint8_t ID, uint8_t len, uint8_t* buf);
	int write(uint8_t ID, uint8_t addr, uint8_t d0);

	void regwrite(uint8_t ID, uint8_t addr, uint8_t d0);
	void regwrite(uint8_t ID, uint8_t addr, uint8_t d0, uint8_t d1);
	void regwrite(uint8_t ID, uint8_t addr, uint8_t d0, uint8_t d1, uint8_t d2);
	void regwrite(uint8_t ID, uint8_t addr, uint8_t d0, uint8_t d1, uint8_t d2, uint8_t d3);
	...
	int moveSpeedRW2(unsigned char ID, int Position, int Speed);
